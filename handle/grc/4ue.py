...
class hello(gr.top_block):
    ...
    def __init__(self):
        ...
        self.zeromq_req_source_1_0_0 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'ipc:///dev/shm/srsue4_tx', 100, False, (-1))
        self.zeromq_req_source_1_0 = zeromq.req_source(gr.sizeof_gr_complex, 1, 'ipc:///dev/shm/srsue3_tx', 100, False, (-1))
        ...
        self.zeromq_rep_sink_2_0_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'ipc:///dev/shm/srsue4_rx', 100, False, (-1))
        self.zeromq_rep_sink_2_0 = zeromq.rep_sink(gr.sizeof_gr_complex, 1, 'ipc:///dev/shm/srsue3_rx', 100, False, (-1))
        ...
        self.connect((self.blocks_throttle_1_0, 0), (self.zeromq_rep_sink_2_0, 0))
        self.connect((self.blocks_throttle_1_0_0, 0), (self.zeromq_rep_sink_2_0_0, 0))
        ...
        self.connect((self.zeromq_req_source_1_0, 0), (self.blocks_add_xx_0, 2))
        self.connect((self.zeromq_req_source_1_0_0, 0), (self.blocks_add_xx_0, 3))
        ...
        self.connect((self.zeromq_req_source_2, 0), (self.blocks_throttle_1_0, 0))
        self.connect((self.zeromq_req_source_2, 0), (self.blocks_throttle_1_0_0, 0))
